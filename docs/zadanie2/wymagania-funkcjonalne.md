...
## Moduły Panelu Wielkiego Mistrza
...
| PIN-FR-009 | System musi prezentować listę zamówień i status spłaty Skarbnikowi.                                             | M         |
...
| STR-FR-009 | System musi przesyłać dane formularza zniżkowego do modułu Powiadomień na kontach zarządowych.                 | M         |
| STR-FR-010 | System musi umożliwiać zamówienie pinów belgijskich oraz przekierowanie do dedykowanego modułu sklepu.         | M         |
| STR-FR-011 | System musi wymagać logowania Google przed dostępem do sklepu z pinami belgijskimi dla odwiedzających.         | M         |
...
| STR-FR-015 | System musi wysyłać powiadomienia o zamówieniach do modułu Powiadomień na kontach zarządowych.                 | M         |
...
| STR-FR-030 | System musi wymagać logowania Google do korzystania z czatu i zgłoszeń problemów.                              | M         |
| STR-FR-031 | System musi uniemożliwiać zbanowanym użytkownikom wysyłanie treści.                                            | M         |
| STR-FR-032 | System musi przekierowywać użytkownika do odpowiednich modułów zgodnie z rolą i statusem konta.                | M         |
| STR-FR-033 | System musi umożliwiać dostęp do sekcji "Blogi" z poziomu menu.                                                | M         |
| STR-FR-034 | System musi umożliwiać zmianę trybu wyświetlania zgodnie z posiadanym statusem użytkownika.                    | M         |
| STR-FR-035 | System musi przesyłać dane formularza zgłoszenia problemu do modułu "Powiadomienia" na kontach moderatorskich. | M         | 
| STR-FR-036 | System musi umożliwiać rejestrację i logowanie użytkownika przez Google OAuth.                                 | M         |
---
...
| AKC-FR-002 | System musi umożliwiać wyświetlanie Bio użytkownika.                                                             | M         |
| AKC-FR-003 | System musi umożliwiać edycję pól Bio zgodnie z posiadanymi uprawnieniami.                                       | M         |
| AKC-FR-004 | System musi wymagać zatwierdzenia moderatora dla pól oznaczonych jako edytowalne za zgodą moderatora w Bio.      | M         |
| AKC-FR-005 | System musi udostępniać dodatkowe pola Bio użytkownikom posiadającym status „Członek” lub „Weteran”.             | S         |
| AKC-FR-006 | System musi wyświetlać listę odznak (flairs) przypisanych użytkownikowi w Bio.                                   | M         |
| AKC-FR-007 | System musi umożliwiać wyświetlenie drzewa genealogicznego użytkownika w Bio.                                    | S         |
| AKC-FR-008 | System musi umożliwiać wysyłanie próśb o zmianę informacji w Bio.                                                | M         |
| AKC-FR-009 | System musi umożliwiać wysyłanie próśb o nadanie i usunięcie flag z poziomu Bio.                                 | M         |
| AKC-FR-010 | System musi umożliwiać wysyłanie próśb o zmianę statusu użytkownika z poziomu Bio.                               | M         |
| AKC-FR-011 | System musi przesyłać formularz uzupełniający po zaakceptowaniu prośby o zmianę statusu, jeśli jest wymagany.    | M         |
| AKC-FR-012 | System musi automatycznie aktualizować status użytkownika po zakończeniu procesu zatwierdzania przez moderatora. | M         |
...
| AKZ-FR-010 | System musi umożliwiać dostęp do powiadomień.                                                                          | M         |
