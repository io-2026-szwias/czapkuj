...
1. **Członek** wybiera opcję "Drzewo genealogiczne" z dashbordu
2. Drzewo zostaje wygenerowane - cel ***DG-0***
3. Zabawa filtrami, kolorowaniem, widokami
## KN - Kompas nawojkowy
1. **Członek** wybiera opcję "Kompas nawojkowy" z dashboardu
2. Strzałka pokazuje mu stronę przeciwną do tej, w którą jest D.S. Nawojka - cel **KN-0****
## KR - Łatwiejsza korespondencja
1. **Kasztelan** wchodzi na maila organizacji
2. Wysyła maila do SSUJ - cel ***KR-0***
...
5. **Skarbnik** wchodzi do "Skarbca"
6. Wybiera "Piny belgijskie"
7. Naciska przycisk "Złóż zamówienie"
8. System przekierowuje go na stronę z pinami
...
1. **Skarbnik** wybiera opcję "BI" z "Panelu Skarbnika"
2. Może tam analizować dane dotyczące członków i organizacji z którą wchodził w transakcje - cel ***SB-1***

1. **Wielki Mistrz** wybiera opcję "Znajomości" z "Centrum zarządzania"
2. Wpisuje w wyszukiwarkę adres e-mail lub wybiera z listy organizację która go interesuje
3. Sprawdza jakie Bractwo ma z nią relację - cel ***SB-2***

## SK - Skarbiec
1. **Członek** wybiera opcję "Składki" z dashboardu
2. Sprawdza za co już ile zapłacił i czy ma jeszcze coś do zapłaty - cel ***SK-0***
3. Może też stamtąd uzupełniać formularze przygotowane przez **Skarbnika**

1. **Skarbnik** loguje się do bankowości
2. Pobiera plik CSV
3. Przeciąga go do strony "Pobierz historię" wybraną w "Panelu Skarbnika"
4. System analizuje plik i przetwarza dane - cel ***SK-1***
5. Dane są dostępne dla wszystkich aplikacji w "Panelu Skarbnika"

1. **Skarbnik** wybiera opcję "Cele składkowe" w "Panelu Skarbnika i naciska "Utwórz cel składkowy"
2. Wpisuje tytuł, kwotę, termin, ew. dodaje formularz, wybiera docelową grupę użytkowników
3. Klika przycisk "Utwórz"
4. Po jakimś czasie w "Celach składkowych" może sprawdzić kto już zapłacił
5. Może też wysłać zbiorowego maila do tych którzy np. nie zapłacili - cel ***SK-2***

## SP - Śpiewnik elektroniczny
1. **Muzyk** wybiera opcję "Śpiewnik" z dashboardu
2. Wybiera piosenkę z listy lub znajduje ją poprzez wyszukiwarkę (po nazwie lub po akordzie - wybiera odpowiednią opcję) - cel ***SP-0***
3. Wybiera tryb "Tryb Cantandiego"
4. Aplikacja podświetla akordy na czerwono i pogrubia je - ***SP-1***
...
## WN - Łatwiejsze wnioski
1. Kasztelan wybiera opcję "Wnioski" z "Centrum zarządzania"
2. Naciska przycisk "Napisz wniosek" - otwiera się formularz z templatką wniosku - cel ***WN-0***
3. Wybiera opcję "Sprawdź najnowsze zarządzenia"
4. System pokazuje najnowsze zarządzenia zbierane przez niego ze strony SSUJ - cel ***WN-1***
5. Wpisuje temat wniosku w wyszukiwarkę - wyświetlają się pasujące wnioski z przeszłości - cel ***WN-2***

## WY - Wyszukiwarka
1. **Bean** wybiera opcję "Wyszukiwarka" z dashboardu
2. Wpisuje w wyszukiwarkę hasło
